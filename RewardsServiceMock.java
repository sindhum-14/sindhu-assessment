...
public class RewardsServiceMock {
	...
	static {
		...
		transactions.add( new MyTransaction(index++, new Customer(1, "Mapper"), 100.0, "Purchase 1", new Date()) );
		transactions.add( new MyTransaction(index++, new Customer(2, "Liver"), 50.0, "Purchase 2", new Date()) );
		transactions.add( new MyTransaction(index++, new Customer(3, "Kakked"), 120.0, "Purchase 3", new Date()) );
